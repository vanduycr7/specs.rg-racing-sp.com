...
<head>
  ...
  <meta name="description" content="Individual, safe and reliable car engine control unit modification online services.">
  <meta name="author" content="">

  <title>Page not found |File Service</title>

 


  <!-- Stylesheets -->
  <link href="https://fonts.googleapis.com/css?family=Orbitron|Oswald|Raleway|Roboto" rel="stylesheet">
...
<body class="page-error page-error-404 layout-full page-login">
  <!--[if lt IE 8]>
  ...
  data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle" style="font-family: Oswald!important;">
      <img class="error-mark animation-slide-top" src="{{asset('images/404.png')}}" alt="404 Not Found">
      <h2 style="color: #fff!important;">Page Not Found !</h2>
      <p class="error-advise" style="color: #fff!important;">YOU SEEM TO BE TRYING TO FIND WAY HOME</p>
      <a class="btn btn-danger btn-round margin-top-15" href="">GO TO HOME PAGE</a>

      <footer class="page-copyright">
        <p>© 2017. {{trans('messages.all-right-reserved')}}</p>
        <div class="social">
  ...
  <script src="{{ asset('assets/js/components/bootbox.js') }}"></script>
  <script src="{{ asset('assets/js/components/bootstrap-sweetalert.js') }}"></script>
