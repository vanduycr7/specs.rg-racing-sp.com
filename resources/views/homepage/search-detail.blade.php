...
$(document).ready(function() {
    ...
    $("#validateForm").validate({
		...
		render($(this).find(":selected").attr("data-id"), $(".model").find(":selected").attr("data-id"));
    });

	if(getUrlParameter('make') && getUrlParameter('model') && getUrlParameter('engine')){
		var make = getUrlParameter('make');
		var model = getUrlParameter('model');
		var engine = getUrlParameter('engine');
